...
namespace Gonzalez_F_Liga_Pro.Data
{
    public class Gonzalez_F_Liga_ProContext : DbContext
    {
        ...
        public DbSet<Gonzalez_F_Liga_Pro.Models.Campeonato> Campeonato { get; set; } = default!;
        public DbSet<Gonzalez_F_Liga_Pro.Models.EquipoCampeonato> EquipoCampeonato { get; set; } = default!;
