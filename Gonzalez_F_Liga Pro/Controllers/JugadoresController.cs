...
namespace Gonzalez_F_Liga_Pro.Controllers
{
    public class JugadorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdJugador,Nombre,Posicion,FechaNacimiento,Nacionalidad,IdEquipo")] Jugador jugador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdJugador,Nombre,Posicion,FechaNacimiento,Nacionalidad,IdEquipo")] Jugador jugador)
        {
